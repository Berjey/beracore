...
const REASONS = [
  ...
  },
  {
    ...
    // 'PCI DSS uyumlu altyapı' BERACORE'un sertifikalı olduğu izlenimi veriyordu;
    // PCI DSS'i kart verisini İŞLEYEN taraf (ödeme sağlayıcı) taşır. 'Düzenli
    // penetrasyon testleri ... operasyonel standardımızdır' ise karşılığı olmayan
    // bir taahhüttü. İkisi de yapılan işin doğru tarifiyle değiştirildi (bulgu A-07).
    desc: 'KVKK uyumlu veri işleme, PCI DSS sertifikalı ödeme sağlayıcılarıyla entegrasyon ve güvenlik gözden geçirmesinden geçmiş kod teslimi.',
  },
  {
