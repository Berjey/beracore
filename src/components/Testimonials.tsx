...
/**
 * Referanslar PROP olarak gelir, koddan import EDİLMEZ (Faz 1.4).
 *
 * Yorumlar veritabanında ve YAYIN İZNİ olmayan kayıt sorgudan hiç dönmez.
 * Bileşen kendi listesini tutsaydı, panelden izni geri çekilen bir referans
 * sitede görünmeye devam ederdi.
 */
export default function Testimonials({ referanslar: TESTIMONIALS }: { referanslar: Referans[] }) {
